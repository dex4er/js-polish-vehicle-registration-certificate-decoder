...
const PolishVehicleRegistrationCertificateNewFormatData = require('./polish-vehicle-registration-certificate-new-format-data')
const PolishVehicleRegistrationCertificateOldFormatData = require('./polish-vehicle-registration-certificate-old-format-data')
...
/**
 * @interface PolishVehicleRegistrationCertificateAddress
 * @property {string} name
 * @property {string} description
 * @property {string[]} value 2 lines
 */

/**
 * @typedef {(PolishVehicleRegistrationCertificateNewFormatData | PolishVehicleRegistrationCertificateOldFormatData)} PolishVehicleRegistrationCertificateData
 */
...
class PolishVehicleRegistrationCertificateDecoder {
  constructor (b64Input) {
    ...
    const fieldsDefinition = {
      ...
      numerPESELLubREGONPosiadaczaDowoduRejestracyjnego: { name: 'C.1.2', description: 'numer PESEL lub REGON dowodu rejestracyjnego', newFormatIndex: 20, oldFormatIndex: 15 },
...
PolishVehicleRegistrationCertificateDecoder.PolishVehicleRegistrationCertificateNewFormatData = PolishVehicleRegistrationCertificateNewFormatData
PolishVehicleRegistrationCertificateDecoder.PolishVehicleRegistrationCertificateOldFormatData = PolishVehicleRegistrationCertificateOldFormatData
